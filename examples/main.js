...
//            location : "../../../../../devices/skylark-devices-webgl/src",
          ...
          {
            name: 'skylark-tweenjs',
            location : "../node_modules/skylark-tweenjs/dist/uncompressed/skylark-tweenjs",

            main: 'main'
          },
          {
            name: 'skylark-videojs-vtt',
            location : "../node_modules/skylark-videojs-vtt/dist/uncompressed/skylark-videojs-vtt",
  ...
  require(["skylark-langx"], function (langx) {
      require(["skylark-videojs"], function (videojs) {
          if (window.initPage) {
              window.initPage(langx,videojs);
          }
      });
  });
//});
